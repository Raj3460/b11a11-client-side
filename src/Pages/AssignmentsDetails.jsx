  ...
  return (
    <div className="min-h-screen bg-base-100 p-6 lg:p-12">
      ...
      <motion.div 
        ...
        className="bg-secondary/20 rounded-xl shadow-md p-8 mb-8 border border-gray-100"
      >
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl lg:text-4xl font-bold  mb-2"> <span className="text-accent">Assignment Name: </span>{title}</h1>
          <p className="">Created by : <span className="font-bold">{name} </span></p>
        </div>
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          >
            <div className="bg-secondary/20 p-4 rounded-lg shadow-sm border border-gray-100">
          ...
          <motion.div
            ...
            className=" bg-secondary/20 p-6 rounded-lg shadow-sm border border-gray-100"
          >
          ...
          >
            <Link to={`/takeAssignment/${_id}`}>
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-primary hover:bg-accent text-white font-medium py-3 px-6 rounded-lg shadow-md transition-all duration-200"
              >
                Start Assignment
              </motion.button>
            </Link>
        ...
        <motion.div
          ...
          transition={{ delay: 0.3 }}
          className="  bg-secondary/20   p-6 rounded-lg shadow-sm border border-gray-100 h-fit sticky top-6"
        >
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full   bg-primary   border border-primary text-info hover:bg-accent font-medium py-2 px-4 rounded-lg shadow-sm transition-all duration-200"
              >
